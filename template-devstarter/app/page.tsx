...
export default function Home() {
  ...
  const skills = [
    ...
    {
      category: "Backend",
      items: ["Spring Boot", "MySQL", "Postman", "Docker"],
    },
    {
      category: "Tools",
  ...
  const blogPosts = [
    {
      title: "Solved 450+ questions with rating of 1500+ on leetcode",
      // date: "Oct 12, 2024",
      readTime: "5 min read",
      excerpt:
    ...
    {
      title: "1st in CTF conducted in Ahouba Tech Fest (IIIT Manipur)",
      date: "Sep 28, 2024",
      readTime: "8 min read",
      excerpt:
    ...
    {
      title: "Open Source Contribution in Fossolgy (Repo with 1k+ stars) with 2 accepted PRs ",
      date: "Aug 15, 2024",
    ...
    {
      title: "CodeChef 2 star with 1400+ rating ",
      date: "Aug 15, 2024",
      readTime: "12 min read",
      excerpt:
          "Automating stateful application management using the Operator pattern.",
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    window.open(
        `https://mail.google.com/mail/?view=cm&fs=1&to=anujrewar5@gmail.com&su=${subject}&body=${body}`,
        "_blank"
    );
  };
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
      ...
      >
        <div className="text-xl font-bold font-mono tracking-tighter">
          Anuj<span className="text-primary">_</span>Rewar
        </div>
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="md:text-xl text-muted-foreground max-w-md leading-relaxed">
              Building scalable backend systems and crafting modern web experiences.
              Specialized in Java, Spring Boot, React, and RESTful APIs.
            </p>
            <div className="flex gap-4 pt-4 items-center">
              ...
              <div className="flex gap-2">
                <Link
                  href="https://github.com/AnujRewar"
                  className={cn(
                ...
                <Link
                  href="https://www.linkedin.com/in/anuj-rewar-450527326/"
                  className={cn(
                    buttonVariants({ variant: "ghost", size: "icon" })
                  )}
                >
                ...
                <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=anujrewar5@gmail.com&su=Hello%20Anuj"
                target="_blank"
                rel="noopener noreferrer"
                className={cn(
                  buttonVariants({ variant: "ghost", size: "icon" })
      ...
      >
        <h2 className="text-4xl font-display mb-12 uppercase">Achievements</h2>

        <div className="grid gap-8">
          {blogPosts.map((post, index) => (
            <Link href="#" key={index} className="group">
              <div className="grid gap-10 md:grid-cols-[1fr_auto] items-baseline justify-between mb-8">
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs font-mono text-muted-foreground">
            <Link href="https://github.com/AnujRewar" className="hover:text-primary transition-colors">
              GITHUB
            </Link>
            <Link href="https://www.linkedin.com/in/anuj-rewar-450527326/" className="hover:text-primary transition-colors">
              LINKEDIN
            </Link>
